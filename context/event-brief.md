...
## Charity
- **Organization:** Andaman Natural Resources Conservation Foundation (ANRCF)
- **Website:** https://anrcf.com/
- **Focus:** Environmental conservation — mangrove reforestation, marine turtle conservation, beach cleanups, youth scholarships
...
- Powerful/influential people in Thailand
- Thailand Tourism Authority president (invitee)
- Hotel groups, corporate organizations

## Languages
- English
- Thai
- Russian
(Tab-based language switcher on the site)

## Website Requirements
- **Stack:** Simple HTML/CSS (static site)
- **Registration:** Form that collects contact info + team type, then shows bank transfer details on confirmation
- **Past Events Section:** Image placeholder — user will supply real photos later
- **Drinks:** Soft drinks and alcohol provided throughout the day
- **Assets:** Use images from anrcf.com for now; swap real venue/event photos later
- **Domain:** TBD — to be discussed
