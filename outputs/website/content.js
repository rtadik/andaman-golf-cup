/**
 * ╔══════════════════════════════════════════════════════════════╗
 * ║           ANDAMAN GOLF CUP 2026 — CONTENT FILE             ║
 * ╠══════════════════════════════════════════════════════════════╣
 * ║  Edit this file to update all website text.                ║
 * ║  Three languages: en (English), th (Thai), ru (Russian)    ║
 * ║  After editing, save and reload the website to see changes.║
 * ╚══════════════════════════════════════════════════════════════╝
 *
 * HOW TO EDIT:
 *   1. Find the section you want to change (e.g. "HERO", "AGENDA")
 *   2. Change the text INSIDE the quotes on the right side
 *   3. Do NOT change the key names on the left side
 *   4. Save the file
 *
 * IMAGES:
 *   Replace hero.png with a new file of the same name.
 *   Gallery images: replace photo1.jpg, photo2.jpg, etc.
 */
...
window.SITE_CONTENT = {
  ...
  en: {
    ...
    // ── SPONSORSHIP ───────────────────────────────────────────────
    'sponsor.heading':       'Support the Next Generation',
    'sponsor.subheading':    'Your partnership helps fund youth conservation education and protect Thailand\'s natural heritage for generations to come.',
    'sponsor.body':          'ANRCF\'s Youth Conservation Fund provides scholarships, environmental training, and community programmes for young Thais. Sponsoring this tournament is a direct investment in that mission — and a statement that your organisation stands with purpose.',
    'sponsor.benefit1':      'Fund Youth Education',
    'sponsor.benefit2':      'Champion Conservation',
    'sponsor.benefit3':      'Stand With Purpose',
    'sponsor.benefit1.desc': 'Your contribution directly finances scholarships and environmental training for the next generation of Thai conservationists.',
    'sponsor.benefit2.desc': 'Help protect mangroves, marine turtles, and coastal ecosystems through programmes that outlast any single event.',
    'sponsor.benefit3.desc': 'Join government leaders, civil society, and businesses united around a mission that matters — and be recognised for it.',
  ...
  th: {
    ...
    // ── NAVIGATION ────────────────────────────────────────────────
    'nav.logo':          'กอล์ฟการกุศลอันดามัน',
    'nav.about':         'เกี่ยวกับโครงการ',
    'nav.agenda':        'กำหนดการ',
    'nav.tickets':       'ค่าลงทะเบียน',
    'nav.sponsorship':   'การสนับสนุน',
    'nav.register':      'ลงทะเบียน',
    'nav.cta':           'ลงทะเบียน',

    // ── HERO ──────────────────────────────────────────────────────
    'hero.eyebrow':      'งานการกุศล ANRCF · กรุงเทพมหานคร ประเทศไทย',
    'hero.headline':     'กอล์ฟการกุศลอันดามันเพื่อสิ่งแวดล้อม 2026',
    'hero.subheadline':  'สถานที่รวมตัวของบุคคลชั้นนำจากภาครัฐ ภาคธุรกิจ และวงการท่องเที่ยว เพื่อร่วมกันขับเคลื่อนการอนุรักษ์ทรัพยากรธรรมชาติ',
    'hero.date':         '26 มิถุนายน 2569 · กรุงเทพมหานคร ประเทศไทย',
    'hero.proof.label':  '35 ทีมเท่านั้น',
    'hero.proof.sub':    'การแข่งขันกอล์ฟการกุศลสุดพิเศษ',
    'hero.cta.register': 'ลงทะเบียนทีมของท่าน',
    ...
    // ── TICKETS ───────────────────────────────────────────────────
    'tickets.heading':            'สำรองที่นั่งของท่าน',
    'tickets.subheading':         'จำกัด 35 ทีมเท่านั้น — กรุณาสำรองที่นั่งก่อนที่นั่งจะเต็ม',
    'tickets.team.badge':         'VVIP',
    ...
    'tickets.team.benefit4':      'รวมงานเลี้ยงรับรองอย่างเป็นทางการ',
    'tickets.team.benefit5':      'อาหารว่างและเครื่องดื่มตลอดทั้งวัน',
    'tickets.team.benefit6':      'การจับรางวัลและรางวัลการแข่งขัน',
    ...
    'tickets.vip.benefit4':       'รวมงานเลี้ยงรับรองอย่างเป็นทางการ',
    'tickets.vip.benefit5':       'อาหารว่างและเครื่องดื่มตลอดทั้งวัน',
    'tickets.vip.benefit6':       'การจับรางวัลและรางวัลการแข่งขัน',
    ...
    'tickets.cta':                'ลงทะเบียนทีมของท่าน',

    // ── SPONSORSHIP ───────────────────────────────────────────────
    'sponsor.heading':       'ร่วมสนับสนุนอนาคตของเยาวชน',
    'sponsor.subheading':    'การสนับสนุนของท่านช่วยให้เยาวชนไทยได้รับการศึกษาด้านการอนุรักษ์ และปกป้องทรัพยากรธรรมชาติของชาติสู่รุ่นต่อไป',
    'sponsor.body':          'กองทุนเยาวชนอนุรักษ์ของมูลนิธิ ANRCF มอบทุนการศึกษา การฝึกอบรมด้านสิ่งแวดล้อม และโครงการชุมชนแก่เยาวชนไทย การสนับสนุนครั้งนี้คือการลงทุนโดยตรงเพื่อพันธกิจดังกล่าว และเป็นการแสดงจุดยืนขององค์กรท่านที่มีต่อสังคม',
    'sponsor.benefit1':      'ลงทุนเพื่อการศึกษาเยาวชน',
    'sponsor.benefit2':      'ร่วมอนุรักษ์ธรรมชาติ',
    'sponsor.benefit3':      'ยืนหยัดเพื่อสิ่งที่มีความหมาย',
    'sponsor.benefit1.desc': 'เงินสนับสนุนของท่านมอบทุนการศึกษาและการฝึกอบรมด้านสิ่งแวดล้อมแก่นักอนุรักษ์รุ่นใหม่ของไทยโดยตรง',
    'sponsor.benefit2.desc': 'ช่วยปกป้องป่าโกงกาง เต่าทะเล และระบบนิเวศชายฝั่งผ่านโครงการที่ยั่งยืนเกินกว่าเพียงหนึ่งงาน',
    'sponsor.benefit3.desc': 'ร่วมกับผู้นำภาครัฐ ภาคประชาสังคม และภาคธุรกิจ ภายใต้พันธกิจเดียวกัน และได้รับการยกย่องในฐานะนั้น',
    'sponsor.cta':           'สอบถามเรื่องการสนับสนุน',

    // ── ABOUT ANRCF ───────────────────────────────────────────────
    'charity.heading':       'เกี่ยวกับมูลนิธิอนุรักษ์ทรัพยากรธรรมชาติอันดามัน',
    ...
    // ── PAST EVENTS ───────────────────────────────────────────────
    'past.heading':    'ผลงานและกิจกรรมที่ผ่านมา',
    ...
    // ── REGISTRATION FORM ─────────────────────────────────────────
    'register.heading':          'แสดงความจำนงเข้าร่วม',
    'register.subheading':       'กรุณากรอกแบบฟอร์มด้านล่าง คณะทำงานจะติดต่อกลับท่านภายใน 48 ชั่วโมง',
    ...
    'register.notes':            'ข้อความเพิ่มเติม',
    'register.submit':           'ยืนยันการลงทะเบียน',
  ...
  ru: {
    ...
    // ── NAVIGATION ────────────────────────────────────────────────
    'nav.logo':          'Андаман Грин Чэрити Гольф',
    'nav.about':         'О турнире',
    ...
    'hero.headline':     'Андаман Грин Чэрити Гольф Турнир 2026',
    ...
    // ── SPONSORSHIP ───────────────────────────────────────────────
    'sponsor.heading':       'Поддержите следующее поколение',
    'sponsor.subheading':    'Ваше партнёрство финансирует экологическое образование молодёжи и защищает природное наследие Таиланда для будущих поколений.',
    'sponsor.body':          'Молодёжный природоохранный фонд ANRCF предоставляет стипендии, экологическое обучение и общественные программы для молодых тайцев. Спонсорство этого турнира — прямая инвестиция в эту миссию и заявление о том, что ваша организация действует с намерением.',
    'sponsor.benefit1':      'Инвестиции в образование молодёжи',
    'sponsor.benefit2':      'Поддержка охраны природы',
    'sponsor.benefit3':      'Действовать с намерением',
    'sponsor.benefit1.desc': 'Ваш взнос напрямую финансирует стипендии и экологическую подготовку будущего поколения тайских природоохранников.',
    'sponsor.benefit2.desc': 'Помогите защитить мангровые леса, морских черепах и прибрежные экосистемы через программы, которые переживут любое отдельное мероприятие.',
    'sponsor.benefit3.desc': 'Присоединитесь к государственным лидерам, гражданскому обществу и бизнесу, объединённым общей миссией — и получите признание за это.',
